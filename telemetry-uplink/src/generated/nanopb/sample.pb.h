...
#define File_filepath_tag                        7
#define File_extension_tag                       8
#define Sample_metric_id_tag                     9
#define Sample_timestamp_tag                     10
#define Sample_primitive_tag                     11
#define Sample_file_tag                          12
...
X(a, STATIC,   SINGULAR, STRING,   filepath,          7) \
X(a, STATIC,   SINGULAR, STRING,   extension,         8)
#define File_CALLBACK NULL
#define File_DEFAULT NULL

#define Sample_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, STRING,   metric_id,         9) \
X(a, STATIC,   SINGULAR, FLOAT,    timestamp,        10) \
X(a, STATIC,   ONEOF,    MESSAGE,  (data,primitive,data.primitive),  11) \
X(a, STATIC,   ONEOF,    MESSAGE,  (data,file,data.file),  12)
