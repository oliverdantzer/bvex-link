 ...
 *
 * This function encodes a single protocol buffers message from a C structure into a stream.
 ...
 *    MyMessage msg = {};
 *    msg.field1 = 42;
 *    auto serialized_data = serialize_nanopb_struct(MyMessage_fields, &msg, 64);
 */
